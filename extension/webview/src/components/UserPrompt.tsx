...
// bubble for the user. A Rewind control sits alongside it, modeled on
// Claude Code's own checkpoint/rewind feature: restores the workspace's
// files to their state before this message, and truncates the conversation
// back to here (the original text is handed back into the composer,
// matching Claude Code's own behavior).
  ...
  return (
    <div className="user-prompt-row">
      ...
      {canRewind && !confirming && (
        <button className="rewind-button" onClick={() => setConfirming(true)} title="Restore code and conversation to before this message">
          <svg width="12" height="12" viewBox="0 0 16 16" fill="none" aria-hidden="true">
            <path
              d="M4 4.5A6 6 0 1 1 3 9"
              stroke="currentColor"
              strokeWidth="1.4"
              strokeLinecap="round"
              fill="none"
